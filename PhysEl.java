...
abstract class PhysEl extends Element
{
    ...
    static void physTick()
    {
        ...
        double ctime = System.nanoTime(); // /current time, does not work
                                          // absolute apparently
        double emtime = 0;
    ...
    // /would like to keep these two separated because rendering water will not
    // be a straight per element render
